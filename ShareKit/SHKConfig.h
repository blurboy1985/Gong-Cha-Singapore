...
#define SHKDeliciousConsumerKey		@"dj0yJmk9aUNTSVJhalFWNHpuJmQ9WVdrOWJtUjFhRkJKTm5FbWNHbzlNVFkxTXpBNE5qSTJNZy0tJnM9Y29uc3VtZXJzZWNyZXQmeD04Zg--"
#define SHKDeliciousSecretKey		@"9785f9d7a0412dba2e8897b1129557b4c3e37933"
...
#define SHKFacebookKey				@"163660813714661"
#define SHKFacebookSecret			@"912ffcf57e2eb44e4a1c5b0e2ad84b73"
#define SHKFacebookSessionProxyURL  @""

// Read It Later - http://readitlaterlist.com/api/?shk
#define SHKReadItLaterKey			@"401T0temg50g5j2e9fd84ejWc5ptc292"
 ...
 */
#define SHKTwitterConsumerKey		@"zvADd7iRGprsRZ4csrM6lw"
#define SHKTwitterSecret			@"Z0e8RtSbONo8hdC8UCZrH7dmKaQpMY6cmSkpcYBCw"
#define SHKTwitterCallbackUrl		@"https://www.facebook.com/GongCha.Singapore" // You need to set this if using OAuth, see note above (xAuth users can skip it)
